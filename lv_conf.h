...
#define LV_TICK_CUSTOM 01
#if LV_TICK_CUSTOM
    #define LV_TICK_CUSTOM_INCLUDE "mbedostick.h"         /*Header for the system time function*/
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR (elapseTimeMS())    /*Expression evaluating to current system time in ms*/
